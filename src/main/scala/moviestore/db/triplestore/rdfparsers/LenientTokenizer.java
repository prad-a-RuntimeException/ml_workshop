...
/**
 * This t**d of a class is a replica of class in Jena lib, which
 * is not extendable, but does not handle problems in quads gracefully.
 * <p>
 * TODO: Rewrite this class, also re-think using Jena.
 *
 * @see: org.apache.jena.riot.tokens.TokenizerText
 */
...
public final class LenientTokenizer implements Tokenizer {
    ...
    public static Tokenizer create(String in) {
        // BOM will be removed
        PeekReader peekReader = PeekReader.makeUTF8(org.apache.commons.io.IOUtils.toInputStream(in));
        Tokenizer tokenizer = new LenientTokenizer(peekReader);
        return tokenizer;
    }

    public static Tokenizer create(InputStream in) {
        // BOM will be removed
    ...
    /*package*/ LenientTokenizer(PeekReader reader) {
        this(reader, false);
    }

    /* package */LenientTokenizer(PeekReader reader, boolean lineMode) {
        this.reader = reader;
