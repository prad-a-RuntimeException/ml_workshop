...
import moviestore.db.triplestore.rdfparsers.CustomRDFDataMgr;
import moviestore.db.triplestore.rdfparsers.LenientNquadParser;
...
import static moviestore.db.triplestore.QuadsBatchHandler.createStreamBatchHandler;
...
public class FileBasedTripleStoreDAO implements TripleStoreDAO {
    ...
    @Override
    public void populate(final InputStream datasetStream, final Lang lang) {
    ...
    @Override
    public void populateNquad(final InputStream datasetStream) {
